...
class ApartmentRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'n_beds' => 'required|numeric|min:1|max:15',
    ...
    public function messages()
    {
        return [
            ...
            'n_rooms.max' => 'Il valore numerico di stanze deve essere massimo di 10',
            ...
            'n_bathrooms.max' => 'Il valore numerico dei bagni deve essere massimo di 3',
            ...
            'n_beds.max' => 'Il valore numerico dei letti deve essere massimo di 15',
            ...
            'square_mts.min' => 'Il valore numerico dei metri quadri deve essere minimo di 80',
            'square_mts.max' => 'Il valore numerico dei metri quadri deve essere massimo di 170',
