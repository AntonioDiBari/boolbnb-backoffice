<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Un volta cancellato l`account, tutte le sue risorse e dati verranno permanentemente cancellati. Prima di cancellarlo, assicurarsi di avere un backup delle informazioni che si intendono salvare.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="text-lg font-medium text-gray-900">
                        {{ __('Sei sicuro/a di voler cancellare il tou account?') }}
                    </h2>
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Un volta cancellato l`account, tutte le sue risorse e dati verranno permanentemente cancellati. Prima di cancellarlo, assicurarsi di avere un backup delle informazioni che si intendono salvare.') }}
                    </p>
